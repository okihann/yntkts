...
@onready var level_label = $ContentBox/LevelLabel
@onready var exp_bar = $ContentBox/ExpBar
@onready var exp_label = $ContentBox/ExpBar/ExpLabel
@onready var passive_list = $ContentBox/PassiveSection/PassiveList
@onready var main_action_btn = $ContentBox/MainBtn
@onready var dim_overlay = $ColorRect
@onready var enhance_dialog = $ColorRect/Enhance
@onready var ascend_dialog = $ColorRect/Ascend
